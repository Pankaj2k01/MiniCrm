    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <Card style={styles.actionCard}>
        <Card.Content>
          ...
          <Button
            mode="outlined"
            onPress={() => Alert.alert('Info', 'Settings functionality coming soon!')}
            style={styles.actionButton}
            icon="cog"
          >
            Settings
      ...
      <Card style={styles.infoCard}>
        <Card.Content>
          ...
          <Paragraph>Mini CRM Mobile Application</Paragraph>
          <Paragraph style={styles.buildInfo}>
            Created with React Native & Redux Toolkit
          </Paragraph>
        </Card.Content>
      </Card>
    </View>
